...
function Character({ choice }) {
  ...
  return (
    <group ref={characterRef} position={[0, 1, 0]}>
      ...
      <group ref={angelWingsRef} position={[0, 0.8, -0.15]} scale={0}>
        {/* Left Wing - Multiple feather layers for depth */}
        <group position={[-0.3, 0, 0]} rotation={[0.1, -0.8, 0.4]}>
      ...
      <group ref={devilWingsRef} position={[0, 0.8, -0.15]} scale={0}>
        {/* Left Wing */}
        <group position={[-0.2, 0, 0]} rotation={[0.2, -0.6, 0.3]}>
